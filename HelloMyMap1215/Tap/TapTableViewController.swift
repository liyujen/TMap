...
import UIKit
import CoreData
class TapTableViewController: UITableViewController, TapViewControllerDelegate{
...
//        }
    ...
    func finishUpdate(notification: Notification){
      if  let tap = notification.userInfo?["tap"] as? Tap{
    ...
    func loadFromCoreData(){
        ...
        let request = NSFetchRequest<Tap>(entityName: "Tap")
